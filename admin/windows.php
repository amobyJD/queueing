					...
					<div class="card-body">
						<table class="table table-bordered table-hover">
							...
							<tbody>
								<?php 
								$i = 1;
								$types = $conn->query("SELECT w.*,t.name as tname FROM transaction_windows w inner join transactions t on t.id = w.transaction_id where w.status = 1 order by section_name asc");
								...
								<tr>
									...
									<td class="">
										 <p> <b><?php echo $row['section_name'] ?></b></p>
									</td>
									<td class="text-center">
										<button class="btn btn-sm btn-primary edit_window" type="button" data-id="<?php echo $row['id'] ?>" data-name="<?php echo $row['section_name'] ?>" data-transaction_id="<?php echo $row['transaction_id'] ?>"  >Edit</button>
